...
class GalleryByTeam extends StatefulWidget {
  final String team;
  GalleryByTeam({required this.team});

  @override
  GridSectionedRouteState createState() => new GridSectionedRouteState();
}

class GridSectionedRouteState extends State<GalleryByTeam> {
