...
class GalleryByYear extends StatefulWidget {
  final String year;
  GalleryByYear({required this.year});

  @override
  GridSectionedRouteState createState() => new GridSectionedRouteState();
}

class GridSectionedRouteState extends State<GalleryByYear> {
