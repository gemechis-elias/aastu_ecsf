...
import 'package:aastu_ecsf/route/home_screen/youtube_player.dart';
...
class SliderImageHeaderAutoRouteState
  ...
  int page = 0;
  Timer? timer;
  late Map<dynamic, dynamic> curObj;
        ...
        Navigator.push<dynamic>(
          ...
          MaterialPageRoute<dynamic>(
            builder: (BuildContext context) =>
                YoutubePlayerDemoApp(ids: getYouTubeVideoId(curObj['link'])),
          ),
        );
      },
      child: Column(
